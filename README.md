...
- Cleans up your code automatically with ease.
...
After navigating to the folder in your command line, you will run sweep with the following command:
...
1. **List Unused Imports:**
   - Use the `list` command to see which imports you can remove.
   - This will show a list of imports that are not being used in your code.

2. **Clean Unused Imports:**
   - Use the `clean` command to automatically remove all unused imports.
   - Your file will then be updated to only include the imports that are in use.
...
## 📄 Examples
Here’s how you might use sweep in practice.
